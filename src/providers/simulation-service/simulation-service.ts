...
export class SimulationService {
  ...
  //public _selectedSimu  : Simulation;
  public _simusBS$        : BehaviorSubject<Array<Simulation>> = new BehaviorSubject([]);
  public   simus$          : Observable<Array<Simulation>> = this._simusBS$.asObservable();

  public _selectedSimuBS$ : BehaviorSubject<Simulation> = new BehaviorSubject(null);
  public   selectedSimu$   : Observable<Simulation> = this._selectedSimuBS$.asObservable();

  public _simuEndPoint : string;
