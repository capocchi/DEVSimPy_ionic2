...
export class ModelService {
  ...
  private _modelsEndPoint : string;

  private _modelStore   : Array<Model> = [];
  ...
  private _modelsBS$    : BehaviorSubject<Array<Model>> = new BehaviorSubject([]);
  public   models$      : Observable <Array<Model>> = this._modelsBS$.asObservable();

  private _selectedModelIndex : number;
  private _selectedModelBS$   : BehaviorSubject<Model> = new BehaviorSubject(null);
